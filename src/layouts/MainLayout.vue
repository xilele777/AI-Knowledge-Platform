...
const activeMenu = computed(() => {
  ...
  if (route.path.startsWith('/shared/')) return '/shared'
  return route.path
})
...
<template>
  <el-container class="layout-shell">
    ...
    <el-aside width="240px" class="layout-aside">
      ...
      <nav class="menu">
        <template v-for="group in mainMenuGroups" :key="group.label">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item disabled class="dropdown-user-info">
                  ...
                  <el-tag v-if="isAdmin" size="small" type="info" class="dropdown-role-tag">管理员</el-tag>
                </el-dropdown-item>
                <el-dropdown-item v-if="isAdmin" command="admin" divided>
                  <el-icon><component :is="iconMap.Document" /></el-icon>
                  管理后台
                </el-dropdown-item>
